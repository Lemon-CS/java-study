package com.lemon.mvcframework.servlet;
...
import com.lemon.mvcframework.pojo.Handler;
...
public class LgDispatcherServlet extends HttpServlet {
    ...
    private void initHandlerMapping() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            String baseUrl = "";
            if (clazz.isAnnotationPresent(LagouRequestMapping.class)) {
                LagouRequestMapping annotation = clazz.getAnnotation(LagouRequestMapping.class);
    ...
    private void doInstance() {
        ...
        try {
            ...
            for (int i = 0; i < classNames.size(); i++) {
                String className = classNames.get(i);   // com.lemon.demo.controller.DemoController
                ...
                if (clazz.isAnnotationPresent(LagouController.class)) {
                    ...
                    LagouService annotation = (LagouService) clazz.getAnnotation(LagouService.class);
                    //获取注解value值
